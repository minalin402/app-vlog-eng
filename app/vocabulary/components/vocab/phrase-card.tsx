...
import type { PhraseItem } from "@/lib/vocab-data"
...
export function PhraseCard({ item, hideChinese }: PhraseCardProps) {
  return (
    <div className="bg-card rounded-xl shadow-sm border border-border p-5 flex flex-col gap-3 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between">
        <h3 className="text-xl font-bold text-foreground">{item.phrase}</h3>
